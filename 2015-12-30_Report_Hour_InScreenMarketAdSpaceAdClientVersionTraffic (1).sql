...
FROM (
    ...
    LEFT OUTER JOIN public.rl2_impression i ON (d.deliveryid = i.deliveryid
        AND i.timestamp >= '2015-12-20 10:00:00' AND i.timestamp < '2015-12-20 11:00:00'
        AND i.valid = 1 	)
    LEFT OUTER JOIN public.rl2_click c ON (d.deliveryid = c.deliveryid 
        AND c.timestamp >= '2015-12-20 10:00:00' AND c.timestamp < '2015-12-20 11:00:00'
        AND c.valid = 1 	)
    LEFT OUTER JOIN public.rl2_event e ON (d.deliveryid = e.deliveryid
        AND e.timestamp >= '2015-12-20 10:00:00' AND e.timestamp < '2015-12-20 11:00:00'
        AND e.valid = 1 	)
